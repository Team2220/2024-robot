...
public class CommandXBoxWrapper2 {

    CommandXboxController xbox;
    double joystickDeadband;
    double triggerDeadZone;

    public CommandXBoxWrapper2(int inPort, double joystickDeadband, double triggerDeadZone) {
    ...
    public CommandXBoxWrapper2(int inPort) {
        this(inPort, .1, .1);
    }
