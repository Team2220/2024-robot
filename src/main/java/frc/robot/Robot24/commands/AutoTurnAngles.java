...
public class AutoTurnAngles extends Command {
    Arm arm;
    ...
    public AutoTurnAngles(Arm arm, DriveTrain driveTrain, DoubleSupplier xSupplier, DoubleSupplier ySupplier, DoubleSupplier rotSupplier) {
    ...
    public void execute() {
        ...
        // * .83;
        System.out.println(Math.toDegrees(Math.atan2(speakerhight, DistanceToSpeaker)));
